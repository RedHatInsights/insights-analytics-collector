...
@register('csv_with_slicing_1-5x', '1.0', format='csv', description='CSV With Slicing 1a', fnc_slicing=trivial_slicing)
def csv_with_slicing1a(full_path, **kwargs):
    return simple_csv(full_path, 'csv_with_slicing_1-5x', 2, 100)


@register('csv_with_slicing_1-5x', '1.0', format='csv', description='CSV With Slicing 1b', fnc_slicing=trivial_slicing)
...
@register('csv_with_slicing_2-3x', '1.0', format='csv', description='CSV With Slicing 2a', fnc_slicing=trivial_slicing)
...
@register('csv_with_slicing_3-2x', '2.0', format='csv', description='CSV With Slicing 3', fnc_slicing=trivial_slicing)
...
@register('csv_with_slicing_2-3x', '2.0', format='csv', description='CSV With Slicing 2b', fnc_slicing=trivial_slicing)
def csv_with_slicing2b(full_path, **kwargs):
    return simple_csv(full_path, 'csv_with_slicing_2-3x', 1, 100)


@register('csv_with_slicing_4-3x', '2.0', format='csv', description='CSV With Slicing 4', fnc_slicing=trivial_slicing)
